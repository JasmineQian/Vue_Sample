<template>
    <div id ="learn-insert container">
        ...
        <form v-if="!submmited">
            <p>学习内容标题</p>
            <input type="text" placeholder="请输入学习的内容" v-model="content.desc" required />

            <p>学习详细内容</p>
            <textarea type="text" placeholder="请输入详细的学习的内容" v-model="content.details" required></textarea>
